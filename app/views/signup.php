...
<body class="bg-black flex items-center justify-center min-h-screen">
    ...
    <form action="action/register_action.php" class="fade-in-scroll w-full max-w-[644px] py-12 bg-[#111827] rounded-3xl shadow-[0_0_80px_rgba(99,102,241,0.15)] flex flex-col items-center pt-[50px] border border-white/10" method="POST">
        ...
        <div class="text-center mb-10 fade-in-scroll stagger-2">
            ...
            <p class="text-gray-400 text-xl">Sudah Memiliki Akun? <span button class="text-blue-500 cursor-pointer"><a href="index.php?url=login">Log In</a></span></p>
        </div>
        ...
        <div class="w-full px-20 fade-in-scroll stagger-4"> 
            <input type="password" name="password" placeholder="Masukkan Password Anda..." class="w-full h-[60px] bg-white/5 border border-white/10 rounded-2xl px-6 text-white text-lg outline-none focus:border-blue-500 transition-all mb-6">
        </div> 

        <div class="w-full px-20 fade-in-scroll stagger-5"> 
            <input type="password" name="confirm_password" placeholder="Konfirmasi Password Anda..." class="w-full h-[60px] bg-white/5 border border-white/10 rounded-2xl px-6 text-white text-lg outline-none focus:border-blue-500 transition-all mb-6">
        </div>

        <div class="w-full px-20 fade-in-scroll stagger-6">
        ...
        <div class="flex items-center justify-center gap-6 w-full fade-in-scroll stagger-6">
