...
<body class="bg-[#05070A] min-h-screen flex flex-col font-sans pb-20">
    ...
    <div class="max-w-[1000px] mx-auto w-full p-10 fade-in">
        ...
        <div class="mb-12">
            <h1 class="text-white text-4xl font-bold mb-4">Tulis Ide Baru</h1>
        ...
        <form action="php/process_idea.php" method="POST" class="flex flex-col gap-8">
            ...
            <div class="flex flex-col md:flex-row items-center gap-6 border-[#0F172A]">
                <div class="w-full md:w-1/3 bg-[#0F172A] rounded-2xl p-2">
                    ...
                    <select name="category" class="w-full bg-transparent text-[#6366F1] font-semibold p-4 outline-none cursor-pointer border-1 border-[#0F172A] rounded-2xl active:bg-transparent transition-all">
                        <option value="Ide Baru" class="bg-[#0F172A]">Ide Baru</option>
                        <option value="Pengembangan Ide" class="bg-[#0F172A]">Pengembangan Ide</option>
                        <option value="Kolaborasi" class="bg-[#0F172A]">Kolaborasi</option>
                        <option value="Inovasi Siswa" class="bg-[#0F172A]">Inovasi Siswa</option>
                    </select>
                </div>
            ...
            <div class="flex items-center justify-between mt-4">
                ...
                <button type="submit" name="submit_idea" class="bg-[#6366F1] text-white text-xl px-16 py-5 rounded-2xl hover:scale-105 transition-all font-bold shadow-[0_10px_30px_rgba(99,102,241,0.2)]">
                    Publikasikan Ide <i class="fa-solid fa-paper-plane ml-3 text-sm"></i>
                </button>
            </div>
